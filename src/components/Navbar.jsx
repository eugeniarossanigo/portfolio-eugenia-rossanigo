...
export default function Navbar({ handleMode, mode }) {
  ...
  return (
    <header id='home' className='bg-insideBg sticky top-0 visible z-20 w-[95%] sm:w-full h-[5vh] flex justify-between items-center shadow-[0_20px_40px_-20px_rgba(166,171,177,1)]'>
