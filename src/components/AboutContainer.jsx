    ...
    <Container link='about' title='About me'>
      <ArticleContainer>
        ...
        <nav className='flex justify-start gap-5 pt-5 pb-2'>
          <a className='w-[110px] bg-green hover:bg-[#2A4858] hover:scale-105 text-sm text-white font-bold text-center rounded-md pt-2' href='https://drive.google.com/file/d/1vn8wfa0zbf7f34F39p87w3juCruX8fmb/view?usp=drive_link' target='_blank' rel='noopener noreferrer'>CV Spanish</a>
